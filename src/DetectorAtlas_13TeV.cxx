...
#include "KLFitter/DetectorAtlas_13TeV.h"
...
namespace KLFitter {
// ---------------------------------------------------------
DetectorAtlas_13TeV::DetectorAtlas_13TeV(std::string folder) : DetectorBase() {
  ...
  m_res_energy_light_jet_eta5 = std::unique_ptr<ResolutionBase>(new ResDoubleGaussE_4{Form("%s/par_energy_lJets_eta5.txt", folder.c_str())});
...
// ---------------------------------------------------------
DetectorAtlas_13TeV::~DetectorAtlas_13TeV() = default;

// ---------------------------------------------------------
ResolutionBase* DetectorAtlas_13TeV::ResEnergyLightJet(double eta) {
  if (fabs(eta) < m_jet_eta_bin_1) {
    ...
    std::cout << "DetectorAtlas_13TeV::ResEnergyLightJet(). Eta range exceeded." << std::endl;
    return nullptr;
  }
}

// ---------------------------------------------------------
ResolutionBase* DetectorAtlas_13TeV::ResEnergyBJet(double eta) {
  if (fabs(eta) < m_jet_eta_bin_1) {
    ...
    std::cout << "DetectorAtlas_13TeV::ResEnergyBJet(). Eta range exceeded." << std::endl;
    return nullptr;
  }
}

// ---------------------------------------------------------
ResolutionBase* DetectorAtlas_13TeV::ResEnergyGluonJet(double eta) {
  if (fabs(eta) < m_jet_eta_bin_1) {
    ...
    std::cout << "DetectorAtlas_13TeV::ResEnergyGluonJet(). Eta range exceeded." << std::endl;
    return nullptr;
  }
}

// ---------------------------------------------------------
ResolutionBase* DetectorAtlas_13TeV::ResEnergyElectron(double eta) {
  if (fabs(eta) < m_electron_eta_bin_1) {
    ...
    std::cout << "DetectorAtlas_13TeV::ResEnergyElectron(). Electron in crack region" << std::endl;
    return nullptr;
  } else if (fabs(eta) <= m_electron_eta_bin_4) {
    return m_res_energy_electron_eta4.get();
  } else {
    std::cout << "DetectorAtlas_13TeV::ResEnergyElectron(). Eta range exceeded." << std::endl;
    return nullptr;
  }
}

// ---------------------------------------------------------
ResolutionBase* DetectorAtlas_13TeV::ResEnergyMuon(double eta) {
  if (fabs(eta) < m_muon_eta_bin_1) {
    ...
    std::cout << "DetectorAtlas_13TeV::ResEnergyMuon(). Eta range exceeded." << std::endl;
    return nullptr;
  }
}

// ---------------------------------------------------------
ResolutionBase* DetectorAtlas_13TeV::ResEnergyPhoton(double eta) {
  if (fabs(eta) < m_photon_eta_bin_1) {
    ...
    std::cout << "DetectorAtlas_13TeV::ResEnergyPhoton(). Eta range exceeded." << std::endl;
    return nullptr;
  }
}

// ---------------------------------------------------------
ResolutionBase* DetectorAtlas_13TeV::ResEtaLightJet(double eta) {
  if (fabs(eta) < m_jet_eta_bin_1) {
    ...
    std::cout << "DetectorAtlas_13TeV::ResEtaLightJet(). Eta range exceeded." << std::endl;
    return nullptr;
  }
}

// ---------------------------------------------------------
ResolutionBase* DetectorAtlas_13TeV::ResEtaBJet(double eta) {
  if (fabs(eta) < m_jet_eta_bin_1) {
    ...
    std::cout << "DetectorAtlas_13TeV::ResEtaBJet(). Eta range exceeded." << std::endl;
    return nullptr;
  }
}

// ---------------------------------------------------------
ResolutionBase* DetectorAtlas_13TeV::ResPhiLightJet(double eta) {
  if (fabs(eta) < m_jet_eta_bin_1) {
    ...
    std::cout << "DetectorAtlas_13TeV::ResPhiLightJet(). Eta range exceeded." << std::endl;
    return nullptr;
  }
}

// ---------------------------------------------------------
ResolutionBase* DetectorAtlas_13TeV::ResPhiBJet(double eta) {
  if (fabs(eta) < m_jet_eta_bin_1) {
    ...
    std::cout << "DetectorAtlas_13TeV::ResPhiBJet(). Eta range exceeded." << std::endl;
    return nullptr;
  }
}

// ---------------------------------------------------------
ResolutionBase* DetectorAtlas_13TeV::ResMissingET() {
