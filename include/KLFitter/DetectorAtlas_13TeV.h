...
#ifndef KLFITTER_DETECTORATLAS_13TEV_H_
#define KLFITTER_DETECTORATLAS_13TEV_H_
 ...
 */
class DetectorAtlas_13TeV : public DetectorBase {
 public:
  /**
   * The default constructor.
   * @param folder The folder with transfer function parameters.
   */
  explicit DetectorAtlas_13TeV(std::string folder = "");
 ...
 private:
  ...
  //std::unique_ptr<ResolutionBase> m_res_eta_light_jet_eta5; //I dont see where this is used?
...
#endif  // KLFITTER_DETECTORATLAS_13TEV_H_
