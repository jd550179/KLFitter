...
#ifndef KLFITTER_LIKELIHOODSGTOPTCHANNELLEPTON_H_
#define KLFITTER_LIKELIHOODSGTOPTCHANNELLEPTON_H_
...
namespace KLFitter {
/**
  * \class KLFitter::LikelihoodSgTopTChannelLepton
  ...
  * lepton+jets.
  */
class LikelihoodSgTopTChannelLepton : public KLFitter::LikelihoodBase {
 public:
...
#endif  // KLFITTER_LIKELIHOODSGTOPTCHANNELLEPTON_H_
