...
#ifndef KLFITTER_RESDOUBLEGAUSSE_6_H_
#define KLFITTER_RESDOUBLEGAUSSE_6_H_
...
namespace KLFitter {
/**
  * \class KLFitter::ResDoubleGaussE_6
  ...
  * parameters.
  */
class ResDoubleGaussE_6 : public ResDoubleGaussBase {
 public:
  ...
  /**
    ...
    */
  explicit ResDoubleGaussE_6(const char * filename);

  /**
    * A constructor.
    * @param parameters The parameters of the parameterization.
    */
  explicit ResDoubleGaussE_6(std::vector<double> const& parameters);
...
#endif  // KLFITTER_RESDOUBLEGAUSSE_6_H_
